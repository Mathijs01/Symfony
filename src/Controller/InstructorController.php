...
class InstructorController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('views/instructor/new.html.twig', [
            'lesson' => $lesson,
            'form' => $form->createView(),
        ]);
    }
    ...
    {
        return $this->render('views/instructor/index.html.twig', [
    ...
    {
        return $this->render('views/instructor/show.html.twig', [
            'lesson' => $lesson,
    ...
    public function edit(Request $request, Lesson $lesson): Response
    {
        ...
        return $this->render('views/instructor/edit.html.twig', [
            'lesson' => $lesson,
            'form' => $form->createView(),
        ]);
    }
